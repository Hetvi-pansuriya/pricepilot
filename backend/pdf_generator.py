...
Color palette matches the ✈ PricePilot UI:
  Background:  #101015  (page bg)
  Surface:     #1a1a22  (cards)
  Surface-2:   #20202c  (inner cards)
  Accent:      #506385  (primary purple-blue)
  Accent-2:    #3d5070  (secondary purple)
  Text:        #F1F0E1
  Muted:       rgba(241,240,225,0.55)
  Success:     #506385
  Warning:     #f59e0b
  Danger:      #ef4444
  Border:      rgba(80,99,133,0.22)
"""
...
/* ── Cover / Header ── */
.cover {
  background: linear-gradient(135deg, #506385 0%, #3d5070 100%);
...
.section-title {
  ...
  margin-bottom: 14px;
  padding-bottom: 8px;
  border-bottom: 1px solid rgba(80,99,133,0.22);
}

/* ── Executive Summary ── */
.exec-card {
  background: #1a1a22;
  border: 1px solid rgba(80,99,133,0.22);
  border-left: 4px solid #506385;
  border-radius: 8px;
  padding: 20px 24px;
  font-size: 13px;
  color: #cbd5e1;
...
.row-baseline td {
  font-weight: 700;
  color: #ffffff;
  background: rgba(80,99,133,0.08) !important;
}

.row-recommended td {
  background: rgba(80,99,133,0.12) !important;
  color: #F1F0E1;
  font-weight: 600;
}
...
.recommended-note {
  ...
  margin-top: 8px;
  padding: 10px 14px;
  background: rgba(80,99,133,0.1);
  border-radius: 6px;
  border-left: 3px solid #506385;
}
...
.tag-undifferentiated { background: rgba(80,99,133,0.15); color: #F1F0E1; }
.tag-unknown          { background: rgba(148,163,184,0.15);color: rgba(241,240,225,0.55); }
...
.pos-well_positioned { background: rgba(80,99,133,0.15); color: #F1F0E1; border: 1px solid rgba(80,99,133,0.3); }
.pos-competitive     { background: rgba(80,99,133,0.15); color: #F1F0E1; border: 1px solid rgba(80,99,133,0.3); }
.pos-unknown         { background: rgba(148,163,184,0.15);color: rgba(241,240,225,0.55); }
...
.strategy-card.conservative { border-top: 3px solid #506385; }
.strategy-card.aggressive   { border-top: 3px solid #ef4444; }
.strategy-card.strategic    { border-top: 3px solid #506385; }
...
.conservative .strategy-mrr { color: #506385; }
.aggressive   .strategy-mrr { color: #ef4444; }
.strategic    .strategy-mrr { color: #506385; }
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="color:rgba(241,240,225,0.55);">{{ item.tier_name }}</td>
              <td>
                <span class="tag tag-{{ item.classification }}">
                  {{ item.classification | replace('_', ' ') }}
                </span>
              </td>
              <td style="color:rgba(241,240,225,0.55);font-size:11px;">{{ item.recommended_action }}</td>
            </tr>
            {% endfor %}
          </tbody>
        </table>
